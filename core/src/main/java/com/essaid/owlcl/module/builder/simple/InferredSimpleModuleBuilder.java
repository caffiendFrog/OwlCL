...
public class InferredSimpleModuleBuilder extends AbstractSimpleModuleBuilder {
	...
	public void addIncludes() {
		Set<OWLEntity> entities = OwlclUtil.getIncludeEntities(module.getModuleConfiguration(),
				false);
	...
	public void addIncludeSubs() {
		Set<OWLEntity> entities = OwlclUtil.getIncludeSubsEntities(module.getModuleConfiguration(),
				false);
	...
	private void addIncludeInstances() {
		Set<OWLEntity> entities = OwlclUtil.getIncludeInstances(module.getModuleConfiguration(),
				false);
	...
	public void removeExcludes() {
		Set<OWLEntity> entities = OwlclUtil.getExcludeEntities(module.getModuleConfiguration(),
				false);
	...
	public void removeExcludeSubs() {
		Set<OWLEntity> entities = OwlclUtil.getExcludeSubsEntities(module.getModuleConfiguration(),
				false);
