...
public class CompareCommand extends AbstractCommand {
	...
	public CompareCommand(MainCommand main) {
		super(main);
		configure();
	}
	...
	enum Action {
		...
		axiomSummary {
			...
			public void execute(CompareCommand command) {
				...
				Set<OWLAxiom> fromAxioms = new TreeSet<OWLAxiom>(OwlclUtil.getAxioms(
						command.fromOntology, true));
				Set<OWLAxiom> toAxioms = new TreeSet<OWLAxiom>(OwlclUtil.getAxioms(
