...
import static isf.module.ModuleVocab.Constant.*;

public enum ModuleVocab {

	module_builders(MODULE_BUILDERS), module_file_name(MODULE_FILE_NAME), module_file_name_inferred(
			MODULE_FILE_NAME_INFERRED), module_iri(MODULE_IRI), module_iri_inferred(
			MODULE_IRI_INFERRED), module_source_exclude(MODULE_SOURCE_EXCLUDE), module_generate(
			MODULE_GENERATE), module_generate_inferred(MODULE_GENERATE_INFERRED);
