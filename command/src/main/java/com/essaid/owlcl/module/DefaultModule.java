...
public class DefaultModule implements IModule {
	...
	private Set<IsftModuleBuilder> builders = new HashSet<IsftModuleBuilder>();
	...
	@Override
	public void addBuilder(IsftModuleBuilder builder) {
		builders.add(builder);

	}

	@Override
	public Set<IsftModuleBuilder> getBuilders() {
		return builders;
	}
	...
	public void generateModule() {
		...
		{
			IsftModuleBuilder builder = ModuleBuilderManager.instance.getBuilder(builderName, this);
		...
		Iterator<IsftModuleBuilder> i = builders.iterator();
		while (i.hasNext())
		{
			IsftModuleBuilder builder = i.next();
			i.remove();
