...
public class EroCommand extends AbstractCommand {
	...
	protected void configure() {
		if (!isModuleBaseDirectorySet()) {
			this.moduleBaseDirectory = new File(getMain().getProject(),
					"module");
		}
		// this.moduleBaseDirectory.mkdirs();

		if (!isEroOutputClassifiedSet()) {
			this.eroOutputClassified = new File(getMain().getJobDirectory(),
					"classified");
		}

		if (!isEroOutputUnclassifiedSet()) {
			this.eroOutputUnclassified = new File(getMain().getJobDirectory(),
					"unclassified");
		}
	...
	private DefaultModule configModule(String moduleName, String outputPath) {
		...
		IModuleConfig mc = ModuleConfigurationV1.getExistingInstance(
				moduleDirecotry.toPath(), getMain().getSharedBaseManager(),
				getMain().getSharedBaseManager(), isfOntology, reasoner, false);
		...
		DefaultModule module = new DefaultModule(mc,
				unclassifiedOutput.toPath(), classifiedOutput.toPath());
	...
	public Object call() throws Exception {
		...
		DefaultModule exgtendedGo = configModule(
				ModuleNames.EAGLEI_EXTENDED_GO, "imports");
		eagleiExtended.importModuleIntoUnclassified(exgtendedGo, false);
		eagleiExtended.importModuleIntoClassified(exgtendedGo, true);

		DefaultModule exgtendedMesh = configModule(
				ModuleNames.EAGLEI_EXTENDED_MESH, "imports");
		...
		DefaultModule exgtendedMP = configModule(
				ModuleNames.EAGLEI_EXTENDED_MP, "imports");
		eagleiExtended.importModuleIntoUnclassified(exgtendedMP, false);
		eagleiExtended.importModuleIntoClassified(exgtendedMP, true);

		DefaultModule exgtendedPato = configModule(
				ModuleNames.EAGLEI_EXTENDED_PATO, "imports");
		...
		DefaultModule exgtendedUberon = configModule(
				ModuleNames.EAGLEI_EXTENDED_UBERON, "imports");
		...
		DefaultModule eagleiApp = configModule(ModuleNames.EAGLEI_APP,
		...
		DefaultModule eagleiExtendedGoApp = configModule(
		...
		DefaultModule eagleiExtendedMeshApp = configModule(
				ModuleNames.EAGLEI_EXTENDED_MESH_APP,
				"application-specific-files");
		eagleiExtendedMeshApp
				.importModuleIntoUnclassified(exgtendedMesh, false);
		...
		DefaultModule eagleiExtendedMpApp = configModule(
		...
		DefaultModule eagleiExtendedPatoApp = configModule(
				ModuleNames.EAGLEI_EXTENDED_PATO_APP,
				"application-specific-files");
		eagleiExtendedPatoApp
				.importModuleIntoUnclassified(exgtendedPato, false);
		...
		DefaultModule eagleiExtendedUberonApp = configModule(
				ModuleNames.EAGLEI_EXTENDED_UBERON_APP,
				"application-specific-files");
		eagleiExtendedUberonApp.importModuleIntoUnclassified(exgtendedUberon,
				false);
		eagleiExtendedUberonApp.importModuleIntoClassified(exgtendedUberon,
				true);
		eagleiExtendedUberonApp.importModuleIntoUnclassified(eagleiAppDef,
				false);
		eagleiExtendedUberonApp.importModuleIntoClassified(eagleiAppDef, true);

		DefaultModule eagleiExtendedApp = configModule(
				ModuleNames.EAGLEI_EXTENDED_APP, "application-specific-files");
		...
		eagleiExtendedApp.importModuleIntoUnclassified(eagleiExtendedGoApp,
				false);
		eagleiExtendedApp.importModuleIntoClassified(eagleiExtendedGoApp, true);
		eagleiExtendedApp.importModuleIntoUnclassified(eagleiExtendedMeshApp,
				false);
		eagleiExtendedApp.importModuleIntoClassified(eagleiExtendedMeshApp,
				true);
		eagleiExtendedApp.importModuleIntoUnclassified(eagleiExtendedMpApp,
				false);
		eagleiExtendedApp.importModuleIntoClassified(eagleiExtendedMpApp, true);
		eagleiExtendedApp.importModuleIntoUnclassified(eagleiExtendedPatoApp,
				false);
		eagleiExtendedApp.importModuleIntoClassified(eagleiExtendedPatoApp,
				true);
		eagleiExtendedApp.importModuleIntoUnclassified(eagleiExtendedUberonApp,
				false);
		eagleiExtendedApp.importModuleIntoClassified(eagleiExtendedUberonApp,
				true);
		...
		if (eroOutputClassified != null) {
			...
			try {
				...
				throw new RuntimeException("Error creating ERO catalog files.",
						e);
			}
		}
