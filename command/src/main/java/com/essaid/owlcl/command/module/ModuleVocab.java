...
public enum ModuleVocab {
	...
	module_unclassified_cleanlegacy(
			ModuleConstant.MODULE_UNCLASSIFIED_CLEANLEGACY),
	...
	module_classified_import_iri(
			ModuleConstant.MODULE_CLASSIFIED_IMPORT_IRI), module_unclassified_import_iri(
			ModuleConstant.MODULE_UNCLASSIFIED_IMPORT_IRI);
