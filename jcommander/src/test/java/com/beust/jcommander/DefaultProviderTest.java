...
public class DefaultProviderTest {
  ...
  public void defaultProvider4() {
    ArgsDefault a = defaultProvider(DEFAULT_PROVIDER, "-log", "19", "-groups", "foo", "-level",
        "13", "f");
  ...
  public void propertyFileDefaultProvider3() {
    ArgsDefault a = defaultProvider(new PropertyFileDefaultProvider(), "-groups", "foo", "-level",
        "13", "f");
  ...
  public void propertyFileDefaultProvider4() {
    ArgsDefault a = defaultProvider(new PropertyFileDefaultProvider(), "-log", "19", "-groups",
        "foo", "-level", "13", "f");
